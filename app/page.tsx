...
export default function Page() {
  ...
  return (
    <>
      <CbsBackground />
      <main className={`relative z-10 min-h-screen flex flex-col items-center px-4 py-12 ${flipState === "front" || flipState === "flip-out" ? "justify-center" : "justify-start sm:justify-center"}`}>
      <div
